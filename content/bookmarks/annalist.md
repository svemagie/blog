  ...
  details:
    sent:
      - target: https://indieweb.org/User:Blog.giersig.eu
        ...
        status: 201
    failed:
      - target: https://annalist.noblogs.org/
        endpoint: https://annalist.noblogs.org/xmlrpc.php
        type: pingback
        error: "<html>\r
    ...
    skipped:
      ...
      - target: https://github.com/svemagie
        reason: No webmention endpoint found
      - target: https://bsky.app/intent/compose?text=annalist%20https%3A%2F%2Fblog.giersig.eu%2Fbookmarks%2Fannalist%2F
        reason: No webmention endpoint found
      - target: https://share.joinmastodon.org/#text=annalist%20https%3A%2F%2Fblog.giersig.eu%2Fbookmarks%2Fannalist%2F
        reason: No webmention endpoint found
...
> Willkommen
> 
> .. auf der Website von Anne Roth, die nach meinem Alter Ego 'annalist' benannt ist. Sie ist noch immer ein bisschen Blog, aber auch Archiv und Kalender.
